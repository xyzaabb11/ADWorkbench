...
{
    sealed class ADWindowsFormsHost : CustomWindowsFormsHost
    {
        /// <summary>
        ...
        /// </param>
        public ADWindowsFormsHost(bool processShortcutsInWPF = false)
        {
        ...
        void CreateBindings(bool processShortcutsInWPF)
        {
            ...
            AddBinding(processShortcutsInWPF, ApplicationCommands.Print, (IPrintable p) => ADService.WinForms.Print(p), p => true);
            AddBinding(processShortcutsInWPF, ApplicationCommands.PrintPreview, (IPrintable p) => ADService.WinForms.PrintPreview(p), p => true);
        }
        ...
        sealed class ComboBoxWrapper : IClipboardHandler
        {
            ...
            public void Cut() { ADService.Clipboard.SetText(comboBox.SelectedText); comboBox.SelectedText = ""; }
            public void Copy() { ADService.Clipboard.SetText(comboBox.SelectedText); }
            public void Paste() { comboBox.SelectedText = ADService.Clipboard.GetText(); }

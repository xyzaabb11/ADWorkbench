...
using PropertyService = ICSharpCode.Core.PropertyService;
...
namespace AD.Workbench.WinForms
{
    public static class FormLocationHelper
    {
        ...
        {
            var owner = window.Owner ?? ADService.Workbench.MainWindow;
            if (owner == null)
        ...
        {
            var mainWindow = ADService.Workbench.MainWindow;

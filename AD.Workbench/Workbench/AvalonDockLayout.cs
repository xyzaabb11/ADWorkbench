...
namespace AD.Workbench.Workbench
{
    sealed class AvalonDockLayout : IWorkbenchLayout
    {
        ...
        public void Attach(IWorkbench workbench)
        {
            ...
            this.workbench = (ADWorkbench)workbench;
            this.workbench.mainContent.Content = dockingManager;
            
           dockingManager.Content = new DocumentPane();
            Busy = true;
            try
            {
...
//             window.ViewContents.AddRange(content.SecondaryViewContents);
        ...
        {
            get { return workbenchWindows.AsReadOnly(); }
        }
		...
		{
			output.WriteLine("AvalonDock: ActiveContent = " + ADWorkbench.GetElementName(dockingManager.ActiveContent));
            output.WriteLine("AvalonDock: ActiveDocument = " + ADWorkbench.GetElementName(dockingManager.ActiveDocument));
		}
#endif
...
//             LoadConfiguration();
        ...
        void dockingManager_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            ...
            {
                ADWorkbench.FocusDebug("AvalonDock: ActiveContent changed to {0}", ADWorkbench.GetElementName(dockingManager.ActiveContent));
            ...
            {
                ADWorkbench.FocusDebug("AvalonDock: ActiveDocument changed to {0}", ADWorkbench.GetElementName(dockingManager.ActiveDocument));
